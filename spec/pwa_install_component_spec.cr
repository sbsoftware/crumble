...
describe Crumble::PwaInstallComponent do
  it "renders as a drop-in layout component via #to_html" do
    ...
    html.should contain(%(<div class="#{Crumble::PwaInstallComponent::InstallPanelActions}">))
    ...
    style_asset.contents.should contain("text-align: center;")
    ...
    style_asset.contents.should contain(".#{Crumble::PwaInstallComponent::InstallPanelActions} {")
    style_asset.contents.should contain("text-align: right;")
